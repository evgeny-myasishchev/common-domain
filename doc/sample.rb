...
module Sample
  ...
  require 'sample/infrastructure/bootstrap'
end

app = Sample::Bootstrap.new do |bootstrap|
...
app.commands_dispatcher.dispatch Sample::Commands::AccountCommands::OpenAccountCommand.new "Primary Account"
app.commands_dispatcher.dispatch Sample::Commands::AccountCommands::OpenAccountCommand.new "Business Account"
...
app.commands_dispatcher.dispatch Sample::Commands::AccountCommands::RenameAccountCommand.new account_to_rename[:number], "Primary Family Account"

Log.info "== Deactivating second account =="
account_to_close = accounts_list[1]
app.commands_dispatcher.dispatch Sample::Commands::AccountCommands::CloseAccountCommand.new account_to_close[:number], "Reorganized business."
